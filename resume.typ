...
#page(background: place(top + right, rect(fill: rgb("2A6465"), width: 30%, height: 100%)))[
  #grid(columns: (70%, 30%), gutter: 0.2in, stroke: none, [
    ...
    - I joined Spotify in 2019, initially as a consultant, before transitioning to a full-time
      employee after a few months. My first mission was to:
      - Mentor and lead a team of engineers in replacing a legacy admin dashboard with new
        technologies while modernizing and innovating the product.
      - Successfully taught TypeScript and React to the team while creating a new
        microservice-based architecture using async Python.
      - Innovated by developing a new transport protocol for low latency and high reliability.
      - Delivered a product that has been in successful use and continuous development for
        five years, with virtually no tech-related incidents.
      - Established close collaboration with our stakeholders and users, conducting numerous
        user studies and utilizing Spotify’s then-new design language to deliver a highly usable product.
      During my tenure with the team, I was responsible for:
    ...
    - Before moving on to my next stop at Spotify, I was responsible for onboarding and
      mentoring the new team replacing us, ensuring their success.
    - My next journey at Spotify involved:
      - Transforming the Customer Support tooling Product Area into a platform.
      - Leading the effort to define and implement a new product as the first successful
        example of a platform for our product area.
      - Leading a team of senior engineers in an RFC-driven approach.
      - Establishing close relationships with stakeholders and designers to identify needs and
        progress through different MVP phases to launch a full product.
      - Coordinating and collaborating with stakeholders, negotiating requirements and
        timelines, defining roadmaps, and ensuring we met our commitments.
      - Focusing on reliability, scalability, and extensibility to create a platform that easily
        onboards new lines of business and customer channels while streamlining integration
        with third-party vendors used by Customer Support.
    - After leading the initial definition, design, and launch of the product, I took ownership of
      the frontend component and:
      - Mentored my team in frontend technologies while actively contributing to other areas.
      - Led an initiative to reduce the number of PagerDuty alerts from our legacy systems by
        implementing a data-driven approach.
      - Created metrics on alert frequency, sources, false positive rates, and categories.
      - Guided the team in improving processes and enhancing our quality culture by
        conducting post-mortems for incidents and reducing alert noise.
      - Successfully reduced PagerDuty alerts by over 80
...
Consult Software Engineer February 2019 – December 2019 Calendar
JustTeck Stockholm, Sweden Map-marker
...
Freelance Software Developer January 2018 – January 2019 Calendar
Various Projects Istanbul, Turkey Map-marker
...
CTO & Agile Coach March 2017 – December 2017 Calendar
Abgostaran Tehran, Iran Map-marker
...
FORMER PROFESSIONAL EXPERIENCE
Senior Consultant January 2016 – June 2017 Calendar
IranTIP Tehran, Iran Map-marker
...
Vice President of Technology Intelligent Information Solutions Center (IIS) January 2016 – June 2017 Calendar
Tehran, Iran Map-marker
...
FORMER PROFESSIONAL EXPERIENCE
CTO & Co-founder May 2016 – March 2017 Calendar
Chejoori Tehran, Iran Map-marker
...
• Database: RethinkDB
CTO & Co-founder April 2013 – January 2016 Calendar
Kelasi Tehran, Iran Map-marker
...
FORMER PROFESSIONAL EXPERIENCE
Web Developer & Designer Student Help Center 2012 – 2013 Calendar
Cyberjaya, Malaysia Map-marker
...
Web Developer, Freelancer, & Consultant 2012 – 2013 Calendar
Various Places Tehran, Iran Map-marker
